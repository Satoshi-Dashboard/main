...
export { getBlogPostPath, SEO_BLOG_PATH, SEO_HUB_PATH };
...
export const SEO_KEYWORD_ROWS = [
  ...
  },
  {
    ...
    pagePath: '/module/s07-bitcoin-nodes-world-map',
  },
  {
    category: 'High volume',
...
export const SEO_QUESTION_ROWS = [
  ...
  },
  {
    ...
    pagePath: '/module/s09-bitcoin-merchant-map',
  },
];
...
export const BLOG_POSTS = [
  {
    ...
    relatedModuleCodes: ['S01', 'S02', 'S04', 'S12'],
    intro: [
  ...
  },
  {
    ...
    relatedModuleCodes: ['S07', 'S08', 'S09'],
    intro: [
  ...
  },
  {
    ...
    relatedModuleCodes: ['S01', 'S04', 'S07', 'S10', 'S12', 'S27'],
    intro: [
  ...
  },
  {
    ...
    relatedModuleCodes: ['S01', 'S04', 'S09', 'S10'],
    intro: [

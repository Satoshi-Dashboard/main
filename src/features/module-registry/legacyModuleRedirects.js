export const LEGACY_MODULE_ALIASES = [
  ...
  { slug: 's06-bitcoin-mempool-queue-v2', slugBase: 'bitcoin-mempool-queue-v2' },
  { slug: 's06-nodes-map', slugBase: 'bitcoin-nodes-world-map' },
  { slug: 's06-bitcoin-nodes-world-map', slugBase: 'bitcoin-nodes-world-map' },
  { slug: 's07-bitcoin-nodes-world-map', slugBase: 'bitcoin-nodes-world-map' },
  ...
  { slug: 's08-lightning-nodes-world-map', slugBase: 'lightning-nodes-world-map' },
  ...
  { slug: 's09-bitcoin-merchant-map', slugBase: 'bitcoin-merchant-map' },

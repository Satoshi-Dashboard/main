...
const MODULE_SEO = {
  ...
  'bitcoin-mempool-queue': {
    title: 'Bitcoin BTC Queue - Fee Bands, Weight & Queue History',
    description: 'Track the Bitcoin mempool queue with stacked fee bands, historical transaction count, queue weight, and total fee pressure across 24h, 30d, and all-time views.',

...
import { ModuleRuntimeContext } from '@/features/module-player/ModuleRuntimeContext.js';
...
export default function ModulePage({ forcedSlug = null }) {
  ...
  useEffect(() => { setDynamicProviders(null); }, [module?.slugBase]);
  ...
  return (
    <main className="player-shell relative h-dvh w-screen overflow-hidden bg-[color:var(--bg-primary)]">
      ...
      {/* ── MODULE CONTENT ── */}
      <ModuleRuntimeContext.Provider value={{ setDynamicProviders }}>
        ...
        >
          {showAbsoluteMetaCard && (
            <SharedMetaAbsoluteCard
              ...
              providers={dynamicProviders ?? moduleMeta.providers}

...
function BottomTile({ label, value, unit = null, decimals = 0, loading, color = UI_COLORS.brand }) {
  ...
  return (
    <div className="flex w-full min-w-0 flex-col items-center gap-1 border-[#2a2a2a] px-2 py-1 text-center sm:px-4">
      ...
      <div className="uppercase tracking-[0.18em] text-white/50" style={{ fontSize: 'var(--fs-tag)' }}>{label}</div>
...
export default function S04_MempoolGauge() {
  ...
  const { loading: loadingOfficial } = useModuleData(fetchOfficial, {
    ...
    bootstrapKey: 'mempoolOfficialUsage',
  ...
  const officialFooterTiles = [
    { label: 'Low Priority', value: officialOverview.feeLow, unit: 'sat/vB', decimals: 2, color: UI_COLORS.positive },
    { label: 'Medium Priority', value: officialOverview.feeMid, unit: 'sat/vB', decimals: 2, color: UI_COLORS.brand },
    { label: 'High Priority', value: officialOverview.feeHigh, unit: 'sat/vB', decimals: 2, color: UI_COLORS.negative },
  ];
  ...
  const nodeFooterTiles = [
    { label: 'Low Priority', value: nodeView.feeEconomy, unit: 'sat/vB', decimals: 2, color: UI_COLORS.positive },
    { label: 'Medium Priority', value: nodeView.feeHalfHour, unit: 'sat/vB', decimals: 2, color: UI_COLORS.brand },
    { label: 'High Priority', value: nodeView.feeFastest, unit: 'sat/vB', decimals: 2, color: UI_COLORS.negative },
  ];

...
| S17 Price Performance | `src/features/modules/under-construction/S17_PricePerformance.jsx` | `fetchBtcSpot()` | Binance -> Binance.US -> cached `btcRates` | On load | Local fallback price `84000` in component after shared spot helper returns null | `src/shared/services/priceApi.js`, `server/services/btcRates.js`, `src/features/modules/under-construction/S17_PricePerformance.jsx` |

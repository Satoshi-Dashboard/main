...
5. Update `README.md` and `.claude/DATA_SOURCE_INTEGRITY_RULES.md` if source/fallback/cadence changes.
...
- Keep `README.md`, this file, and the relevant `.claude/*.md` policy files aligned when architecture or data flow changes.
